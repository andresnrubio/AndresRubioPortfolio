  ...
  return (
    <HomeContainer>
      ...
      <p>
        ...
        apasionado por la tecnología y siempre listo para aprender sobre las últimas novedades en el
        campo.
      </p>
      <br />
      <p>
        Con una combinación de experiencias profesionales en varias empresas y proyectos como
        freelancer, me desenvuelvo en el dinámico mundo del desarrollo de software, donde mezclo la
        creatividad con la técnica para crear soluciones digitales excepcionales.
      </p>
      <br />
      <p>
